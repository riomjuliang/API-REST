 ...
 *   https://datatables.net/download/#dt/dt-1.10.16/af-2.2.2/b-1.5.1/b-html5-1.5.1/fc-3.2.4
 *
 * Included libraries:
 *   DataTables 1.10.16, AutoFill 2.2.2, Buttons 1.5.1, HTML5 export 1.5.1, FixedColumns 3.2.4
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.10.16/af-2.2.2/b-1.5.1/b-html5-1.5.1/fc-3.2.4",
	...
	var __htmlEscapeProdEntities = function ( d ) {
	...
	DataTable.render = {
		number: function ( thousands, decimal, precision, prefix, postfix ) {
			return {
				display: function ( d ) {
					...
					if ( isNaN( flo ) ) {
						return __htmlEscapeProdEntities( d );
					}
		...
		text: function () {
			return {
				display: __htmlEscapeProdEntities
			};
		}
	};
