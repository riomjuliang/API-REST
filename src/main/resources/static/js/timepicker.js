...
var content = $('<div class="timepicker">\
		<div v-show class="title">Hora</div>\
			<div class="chose-all">\
				<div class="handle">\
				...
				<div class="text">\
					...
					<div class="cell-2">:</div>\
					<div class="cell-4"><a class="js-minute-show" title="Hora"></a></div>\
				</div>\
				<div class="handle">\
...
timepicker.bindEvent = function () {
	...
	// 选择分钟
		...
		thisTimePicker.title.text('Minutos');
	...
	// 选择小时
		...
		thisTimePicker.choseAll.show();
		thisTimePicker.title.text('Hora');
	// 阻止冒泡
	}).on('click',function(e) {
		e.stopPropagation();
	});
